...
public class Config {
    ...
    enum CfgEnt {
        ...
        PPMS_ENABLED(CfgCat.PER_PLAYER_MOB_SPAWNING, "per_player_mob_spawning_enabled", "Controls whether mob spawning is switched to a per-player system.", true),
        PPMS_LOGGING_ENABLED(CfgCat.PER_PLAYER_MOB_SPAWNING, "mob_spawning_logging", "Adds development logging to check if mobs are spawning properly", false),
        PPMS_MIDDLE_EARTH_MOB_CAP(CfgCat.PER_PLAYER_MOB_SPAWNING, "middle_earth", "Number of mob 'points' per player in the middle earth dimension", 114, 0, 2000),
        PPMS_UTUMNO_MOB_CAP(CfgCat.PER_PLAYER_MOB_SPAWNING, "utummno", "Number of mobs 'points' per player in the utumno dimension", 860, 0, 2000),
        PPMS_MAX_SPAWNS_PER_CYCLE(CfgCat.PER_PLAYER_MOB_SPAWNING, "max_spawns_per_cycle", "Number of mob 'points' per player in the middle earth dimension", 10, 1, 100),
        PPMS_CHUNK_RANGE(CfgCat.PER_PLAYER_MOB_SPAWNING, "chunk_range", "Number of mobs 'points' per player in the middle earth dimension", 6, 5, 7),
        CRM_ENABLED( CfgCat.CRAFTING_RECIPE_MODULE, "custom_crafting_recipes_enabled", "Controls whether Custom Crafting recipes are added.", true ),
        CRM_REDSTONE_CRAFTING_ENABLED( CfgCat.CRAFTING_RECIPE_MODULE, "redstone_crafting_enabled", "Adds redstone dust crafting recipe", true ),
        CRM_QUARTZ_CRAFTING_ENABLED( CfgCat.CRAFTING_RECIPE_MODULE, "quartz_crafting_enabled", "Adds quartz crystal crafting recipe", true ),
        CRM_ENDER_CHEST_CRAFTING_ENABLED( CfgCat.CRAFTING_RECIPE_MODULE, "ender_chest_crafting_enabled", "Adds LOTR Friendly recipe for ender chests", true ),
        CRM_BEACON_CRAFTING_ENABLED( CfgCat.CRAFTING_RECIPE_MODULE, "beacon_crafting_enabled", "Adds LOTR Friendly recipe for beacons", true ),
        CRM_STONE_CHEST_CRAFTING_ENABLED( CfgCat.CRAFTING_RECIPE_MODULE, "stone_chest_crafting_enabled", "Adds recipe for stone chests.", true ),
        CRM_ENCHANTED_BOOK_CRAFTING_ENABLED( CfgCat.CRAFTING_RECIPE_MODULE, "enchanted_book_crafting_enabled", "Gates all enchanted book crafting behind a single config.", true ),
        CRM_ALLOW_LOWER_TIER_ENCHANTMENT_CRAFTING( CfgCat.CRAFTING_RECIPE_MODULE, "enchanted_book_lower_tier_crafting_enabled", "Allows enabled book recipes for non-max tier enchantments by reducing the number of the required scrolls.", true ),
        CRM_EFFICIENCY_CRAFTING_ENABLED( CfgCat.CRAFTING_RECIPE_MODULE, "efficiency_crafting_enabled", "Allows Efficiency 5 books to be crafted with scrolls", true ),
        CRM_FORTUNE_CRAFTING_ENABLED( CfgCat.CRAFTING_RECIPE_MODULE, "fortune_crafting_enabled", "Allows Fortune 3 books to be crafted with scrolls", true ),
        CRM_UNBREAKING_CRAFTING_ENABLED( CfgCat.CRAFTING_RECIPE_MODULE, "unbreaking_crafting_enabled", "Allows Unbreaking 3 books to be crafted with scrolls", true ),
        CRM_SHARPNESS_CRAFTING_ENABLED( CfgCat.CRAFTING_RECIPE_MODULE, "sharpness_crafting_enabled", "Allows Sharpness 5 books to be crafted with scrolls", true ),
        CRM_FIRE_ASPECT_CRAFTING_ENABLED( CfgCat.CRAFTING_RECIPE_MODULE, "fire_aspect_crafting_enabled", "Allows Fire Aspect 2 books to be crafted with scrolls", true ),
        CRM_KNOCKBACK_CRAFTING_ENABLED( CfgCat.CRAFTING_RECIPE_MODULE, "knockback_crafting_enabled", "Allows Knockback 2 to be crafted with scrolls", true ),
        CRM_LOOTING_CRAFTING_ENABLED( CfgCat.CRAFTING_RECIPE_MODULE, "looting_crafting_enabled", "Allows Looting 3 books to be crafted with scrolls", true ),
        CRM_PROTECTION_CRAFTING_ENABLED( CfgCat.CRAFTING_RECIPE_MODULE, "protection_crafting_enabled", "Allows Protection 4 books to be crafted with scrolls", true ),
        CRM_FIRE_PROT_CRAFTING_ENABLED( CfgCat.CRAFTING_RECIPE_MODULE, "fire_prot_crafting_enabled", "Allows Fire Protection 4 books to be crafted with scrolls", true ),
        CRM_PROJ_PROT_CRAFTING_ENABLED( CfgCat.CRAFTING_RECIPE_MODULE, "proj_prot_crafting_enabled", "Allows Projectile Protection 4 books to be crafted with scrolls", true ),
        CRM_FEATHER_FALLING_CRAFTING_ENABLED( CfgCat.CRAFTING_RECIPE_MODULE, "feather_falling_crafting_enabled", "Allows Feather Falling 4 books to be crafted with scrolls", true ),
        CRM_POWER_CRAFTING_ENABLED( CfgCat.CRAFTING_RECIPE_MODULE, "power_crafting_enabled", "Allows Power 5 books to be crafted with scrolls", true ),
        CRM_PUNCH_CRAFTING_ENABLED( CfgCat.CRAFTING_RECIPE_MODULE, "punch_crafting_enabled", "Allows Punch 2 books to be crafted with scrolls", true ),
        CRM_ADD_HARDY_HANDY_SCROLL_RECIPES( CfgCat.CRAFTING_RECIPE_MODULE, "handy_hardy_scroll_recipes", "Allows 2 scrolls and a feather or cobblestone to be crafted into a handy or hardy scroll (respectively)", true ),
        CRM_REMOVE_REFORGING_COOLDOWN( CfgCat.CRAFTING_RECIPE_MODULE, "remove_reforge_cooldown", "Remove the reforging cooldown (careful not to spam :)", true ),
        MMM_ENABLED(CfgCat.MORE_MONEY_MODULE, "more_money_module_enabled", "Controls all coin module features", true ),
        MMM_LARGER_COINS_ENABLED(CfgCat.MORE_MONEY_MODULE, "higher_currencies_enabled", "Adds higher coin denomination past 100", true ),
        MMM_BULK_COIN_CONVERSION( CfgCat.MORE_MONEY_MODULE, "bulk_coin_conversion", "Adds crafting recipe for full pouches of coins.", true ),
        MMM_GUI_BULK_COIN_CONVERSION(CfgCat.MORE_MONEY_MODULE, "gui_coin_conversion", "Adds button to coin conversion gui to compact all coins in inventory", true ),
        WM_ENABLED( CfgCat.WAYPOINTS_MODULE, "enabled", "Adds new default waypoints to the map", false ),
        WM_MOVE_HELMS_DEEP( CfgCat.WAYPOINTS_MODULE, "move_helms_deep", "Move helms deep to the position where the build is on the LOTR Kings server", false ),
    ...
    public record CraftingRecipeModuleConfig( boolean enabled, boolean redstone, boolean quartz, boolean enderChest,
                                              boolean beacon, boolean stoneChest, boolean enchantedBooks,
                                              boolean lowTierEnchantedBooks, boolean efficiency, boolean fortune,
                                              boolean unbreaking, boolean sharpness, boolean fireAspect,
                                              boolean knockback, boolean looting, boolean protection,
                                              boolean fireProtection, boolean projectileProtection,
                                              boolean featherFalling, boolean power, boolean punch,
                                              boolean handyHardyScrolls, boolean removeReforgeCooldown ) {}
    ...
    @Desugar
    public record WaypointsModuleConfig( boolean enabled, boolean moveHelmsDeep, boolean moveIsengard, boolean addKingsCustomWaypoints, boolean removeDolAmrothMountains, boolean makeAllWaypointsFactionSpecific ) {}
