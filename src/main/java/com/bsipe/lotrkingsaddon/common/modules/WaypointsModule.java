...
//            ReflectionHelper.setPrivateValue( LOTRWaypoint.class,LOTRWaypoint.DOL_AMROTH, LOTRWaypoint.mapToWorldX( 1156), COORD_X_param);
        }
    }
...
//            setAllFactionSpecificWPs();
        ...
        if ( config.moveIsengard() ) {
            ...
            ReflectionHelper.setPrivateValue( LOTRWaypoint.class,LOTRWaypoint.ISENGARD, LOTRWaypoint.mapToWorldZ(1058 ), COORD_Z_param);
