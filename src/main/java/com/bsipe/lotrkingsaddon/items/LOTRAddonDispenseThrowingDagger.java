...
public class LOTRAddonDispenseThrowingDagger extends BehaviorDefaultDispenseItem {
    public LOTRAddonDispenseThrowingDagger() {
    }
    ...
    public ItemStack dispenseStack(IBlockSource dispenser, ItemStack itemstack) {
        ...
        LOTRAddonEntityThrowingDagger axe = new LOTRAddonEntityThrowingDagger(world, itemstack.copy(), iposition.getX(), iposition.getY(), iposition.getZ());
        axe.setThrowableHeading((double)enumfacing.getFrontOffsetX(), (double)((float)enumfacing.getFrontOffsetY() + 0.1F), (double)enumfacing.getFrontOffsetZ(), 1.1F, 6.0F);
        axe.canBePickedUp = 1;
