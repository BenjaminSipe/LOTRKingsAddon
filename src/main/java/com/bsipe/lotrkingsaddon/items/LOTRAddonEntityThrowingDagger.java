...
public class LOTRAddonEntityThrowingDagger extends LOTREntityProjectileBase {
    ...
    public LOTRAddonEntityThrowingDagger(World world ) { super( world ); }
    ...
    public float getBaseImpactDamage(Entity entity, ItemStack itemstack) {
        ...
        float damage = ((LOTRAddonThrowingDagger)itemstack.getItem()).getRangedDamageMultiplier(itemstack, this.shootingEntity, entity);
        return speed * damage;
        }
    }
}
