...
public class LOTRAddonThrowingDagger extends LOTRItemDagger {
    ...
    public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer entityplayer) {
        LOTRAddonEntityThrowingDagger axe = new LOTRAddonEntityThrowingDagger(world, entityplayer, itemstack.copy(), 2.0F);
    ...
    public boolean getIsRepairable(ItemStack itemstack, ItemStack repairItem) {
        return LOTRRecipes.checkItemEquals(this.axeMaterial.getRepairItemStack(), repairItem) ? true : super.getIsRepairable(itemstack, repairItem);
    }
